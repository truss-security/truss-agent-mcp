...
Task-oriented docs for installing and using `truss-mcp`.

| Guide | When to read |
|-------|----------------|
| [getting-started.md](./getting-started.md) | First install and first query |
...
| [publishing.md](./publishing.md) | npm publish, remote doctor gate, integration tests |

Reference docs: [../docs/README.md](../docs/README.md) · Hosted OAuth: [../docs/05-hosted-mcp-oauth-architecture.md](../docs/05-hosted-mcp-oauth-architecture.md)
