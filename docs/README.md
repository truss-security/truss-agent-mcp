...
| 07 | [unified-agent-delivery-architecture.md](./07-unified-agent-delivery-architecture.md) | Merge plan: schedules, env-ref secrets, chat/SIEM/EDR/SOAR/NGFW push into local MCP |
